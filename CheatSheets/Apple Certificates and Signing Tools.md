...
| `xcrun productsign`                              | Tool for signing package files                                 |
| `xcrun productbuild`                             | Tool for creating package files                                |
...
5. Then staple the notarization to the app with `xcrun stapler staple "scratch/MyApp.app"`
